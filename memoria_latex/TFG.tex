...
\renewcommand{\tablename}{Tabla}              \renewcommand{\listtablename}{Índice de tablas}
...
\input{tex/Fundamentos_Teoricos}
...
\hypertarget{ch:anexos}{%
    ...
    \input{tex/apendice_llm.tex}
%\cleardoublepage
%\hypertarget{ch:anexos-latex}{%
%    \input{latex.tex}}
