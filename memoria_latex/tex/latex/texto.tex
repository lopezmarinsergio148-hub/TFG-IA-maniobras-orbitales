...
Si quieres lista de acrónimos debes marcar los acrónimos con una etiqueta especial.  Por ejemplo, así se pondría la primera vez un \acrfull{RL}.  Una vez que se ha usado el acrónimo, ya se puede usar en forma abreviada, como en~\acrshort{RL}.  Marca incluso en este caso los acrónimos, porque así el PDF permitirá navegar a la definición pinchando sobre él.
